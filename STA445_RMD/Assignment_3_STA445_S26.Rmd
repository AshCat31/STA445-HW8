...
480 and 1 are the correct results.
...
The if else version is about 10x faster and was easier to write than the for loop.
...
FizzBuzz <- function(n) {
  nums <- 1:n
  res <- ifelse(nums %% 3, as.character(nums), "Fizz")
  res <- ifelse(nums %% 5, res, "Buzz")
  res <- ifelse(nums %% 15, res, "Fizz Buzz")
  return(res)
}
```
